...
def main(data_path, dis_matrix_path, path_out, len_x, len_y, expanding_rules, is_col):
    ...
    continual_list = list(np.load("./spatial_expansion_continual.npy"))
    expanding_list = list(np.load("./spatial_expansion_expanding.npy"))
...
if __name__ == "__main__":
    ...
    len_x, len_y = 12, 12
    path_out = Path("../processed/spatial_pems-63_296-3_447-2-12_12_C.npz")
